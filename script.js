$(document).ready(function () {
    ...
    // Game Rules
    let progressTimer = 3; // How Long the blocks will be lighted up
    let AmountOfBlocks = 7; // How many blocks to be displayed
    const DisplayBlockNumbers = true // Should blocks have numbers in them?
